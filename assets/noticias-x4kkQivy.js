import{A as r}from"./api-CarVputC.js";class s{static async init(){await this.renderAllNews()}static async renderAllNews(){const a=await r.getNews(),t=document.getElementById("news-grid-full");if(t){if(a.length===0){t.innerHTML=`
